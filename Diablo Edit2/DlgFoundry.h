...
private:
	...
	void SetupPropParameters(int id, QWORD value, BOOL checked);	//根据属性id和值，设置参数控件
	...
	std::pair<BOOL, QWORD> GatherParamaters(const CPropertyMetaDataItem & meta) const;		//收集参数控件的值，得到属性的参数
